...
public class CustomAbsoluteLayout : AbsoluteLayout, IDisposable, ITapCustomComponent
{
    ...
    {
        var control = (CustomAbsoluteLayout)bindable;
    ...
    {
        if (ResponsiveConfig != null && GlobalConstants.ScreenHeight > 0 && GlobalConstants.ScreenWidth > 0 && GlobalConstants.ScreenDensity > 0)
        {
